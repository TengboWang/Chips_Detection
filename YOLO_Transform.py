    ...
    for fullname in filelist:  # fullname='/.../P000?.txt'
        ...
        with open(os.path.join(dstpath, name + '.txt'), 'w') as f_out:
            ...
            for i, obj in enumerate(objects):
                ...
                width_ratio=1024/img_w
                height_ratio=1024/img_h
                poly[:, 0]=poly[:, 0]*width_ratio
                poly[:, 1]=poly[:, 1]*height_ratio
                print(poly[:, 0])
                print(poly[:, 1])
                img_w=1024
                img_h=1024
...
if __name__ == '__main__':
    ...
    # dota2LongSideFormat('./data_trans/images',
    #                     './data_trans/labelTxt',
    #                     './data_trans/yolo/',
    #                     util.classes_name)

    drawLongsideFormatimg(imgpath='data_trans/images',
                          txtpath='data_trans/yolo',
                          dstpath='data_trans/draw_longside_img',
                          extractclassname=util.classes_name)
